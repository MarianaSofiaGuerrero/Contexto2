...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        /**
         * Objeto encargado de manejar las operaciones CRUD
         */
        ...
        /**
         * Se reinicia el CRUD para evitar que los datos de prueba
         * aparezcan en el menú interactivo.
         */
        ...
        /**
         * Menú interactivo para gestión de alimentos y archivo binario.
         */
        do {
            System.out.println("\n---------------------- MENU ----------------------");
    ...
    /**
     * Crea un alimento de tipo Procesado.
     * 
